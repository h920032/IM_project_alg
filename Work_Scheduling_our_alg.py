...
import pandas as pd
import random as rd
import tool.gene_alg as gen
from tool.CSR_order import CSR_ORDER
from tool.LIMIT_ORDER import LIMIT_ORDER
...
# GENE(): 切分並交配的函數 
#========================================================================#
def GENE(K_type_dict, timelimit, available_sol, fix, generation, per_month_dir='./data/per_month/'):
	return gen.gene_alg(K_type_dict, timelimit, available_sol, fix, generation, per_month_dir)
...
gene_result = GENE(K_type_dict, timelimit,available_sol, fix, generation, per_month_dir=dir_name+'per_month/')
